...
import { VolumePriceReport } from '@/features/reports/components';
...
export default async function VolumePriceReportPage() {
  const [seasonsResult, riceTypes] = await Promise.all([
