...
export async function GET(request: NextRequest) {
  try {
    ...
    const backendUrl = `${process.env.NEXT_PUBLIC_API_URL}/finances/advances/export/excel?${backendParams.toString()}`;
    ...
    const contentDisposition =
      ...
      'attachment; filename="anticipos.xlsx"';
    ...
    console.error('[API][advances/export] Error:', error);
