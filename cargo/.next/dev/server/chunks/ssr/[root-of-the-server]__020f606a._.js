...
"[project]/paddy/cargo/src/lib/formatChileanRut.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/paddy/cargo/src/lib/receptionTurno.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/paddy/cargo/src/actions/truckReceptionActions.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";

/* __next_internal_action_entry_do_not_use__ [{"0037935cdcff978a6805f61981c08fe8cdfab5eaf9":"getNextTurnoAction","00ffed22151d008e6a1c3373c7ae3614463e364065":"getTurnosTodayAction","401fd7e2cce3cc7b43e9956d041f18b7c603deb92a":"createTruckReceptionAction","4021f17fb898e1ad86fcca663f85fed167403e6876":"getTruckReceptionsGridAction","4033c54ef6a1cf7531097325a91c4fd9100a53bead":"getTruckReceptionByIdAction","405e7bbec01d48e9d7d90f457ec0439586ff0b456f":"deleteTruckReceptionAction","40607a23e110a792b478bd237b3a01d9cf5060c36c":"recordTareWeightAction","60052f665745ab54597007d2d90027fb8d4202a216":"updateTruckReceptionAction","608d8ff96e8b098cee62cf6b38d1544b5a5ec66e31":"updateTruckTurnoAction","60af9d152c7f1d88e888614da640f34a00bd2f0c61":"updateTruckStatusAction"},"",""] */ __turbopack_context__.s([
...
var __TURBOPACK__imported__module__$5b$project$5d2f$paddy$2f$cargo$2f$src$2f$lib$2f$formatChileanRut$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/paddy/cargo/src/lib/formatChileanRut.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$paddy$2f$cargo$2f$src$2f$lib$2f$receptionTurno$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/paddy/cargo/src/lib/receptionTurno.ts [app-rsc] (ecmascript)");
...
function parseTruckReceptionApiError(payload, fallback) {
...
async function getTruckReceptionsGridAction(params) {
    try {
        ...
        const response = await fetch(`${API_URL}/logistics/truck-receptions/grid?${qs.toString()}`, {
            headers: {
                Authorization: `Bearer ${session.user.accessToken}`
            },
            cache: 'no-store'
        ...
        const rows = raw.map((r)=>{
            ...
            return {
                ...
                numero_turno: r.numero_turno != null && !Number.isNaN(Number(r.numero_turno)) ? Number(r.numero_turno) : null,
                ...
                producer_rut: producer?.rut != null ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$paddy$2f$cargo$2f$src$2f$lib$2f$formatChileanRut$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["formatChileanRut"])(String(producer.rut)) : ''
            };
        });
        return {
            rows,
...
async function updateTruckReceptionAction(id, payload) {
    try {
        const session = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$paddy$2f$cargo$2f$node_modules$2f$next$2d$auth$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getServerSession"])(__TURBOPACK__imported__module__$5b$project$5d2f$paddy$2f$cargo$2f$src$2f$lib$2f$auth$2e$config$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["authOptions"]);
        if (!session?.user?.accessToken) {
            throw new Error('No autenticado');
        ...
        if (!response.ok) {
            throw new Error(parseTruckReceptionApiError(responsePayload, `HTTP ${response.status}: ${response.statusText}`));
        }
...
async function updateTruckTurnoAction(id, numeroTurno) {
    ...
    if (!Number.isFinite(slot) || slot < __TURBOPACK__imported__module__$5b$project$5d2f$paddy$2f$cargo$2f$src$2f$lib$2f$receptionTurno$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["RECEPTION_TURNO_MIN"] || slot > __TURBOPACK__imported__module__$5b$project$5d2f$paddy$2f$cargo$2f$src$2f$lib$2f$receptionTurno$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["RECEPTION_TURNO_MAX"]) {
        throw new Error(`Turno inválido: debe ser un entero entre ${__TURBOPACK__imported__module__$5b$project$5d2f$paddy$2f$cargo$2f$src$2f$lib$2f$receptionTurno$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["RECEPTION_TURNO_MIN"]} y ${__TURBOPACK__imported__module__$5b$project$5d2f$paddy$2f$cargo$2f$src$2f$lib$2f$receptionTurno$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["RECEPTION_TURNO_MAX"]}`);
    }
    return updateTruckReceptionAction(id, {
        numero_turno: slot
    });
}
async function deleteTruckReceptionAction(id) {
    try {
        const session = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$paddy$2f$cargo$2f$node_modules$2f$next$2d$auth$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getServerSession"])(__TURBOPACK__imported__module__$5b$project$5d2f$paddy$2f$cargo$2f$src$2f$lib$2f$auth$2e$config$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["authOptions"]);
        if (!session?.user?.accessToken) {
            throw new Error('No autenticado');
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$paddy$2f$cargo$2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(createTruckReceptionAction, "401fd7e2cce3cc7b43e9956d041f18b7c603deb92a", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$paddy$2f$cargo$2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(recordTareWeightAction, "40607a23e110a792b478bd237b3a01d9cf5060c36c", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$paddy$2f$cargo$2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getNextTurnoAction, "0037935cdcff978a6805f61981c08fe8cdfab5eaf9", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$paddy$2f$cargo$2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getTruckReceptionsGridAction, "4021f17fb898e1ad86fcca663f85fed167403e6876", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$paddy$2f$cargo$2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getTurnosTodayAction, "00ffed22151d008e6a1c3373c7ae3614463e364065", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$paddy$2f$cargo$2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getTruckReceptionByIdAction, "4033c54ef6a1cf7531097325a91c4fd9100a53bead", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$paddy$2f$cargo$2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(updateTruckStatusAction, "60af9d152c7f1d88e888614da640f34a00bd2f0c61", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$paddy$2f$cargo$2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(updateTruckReceptionAction, "60052f665745ab54597007d2d90027fb8d4202a216", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$paddy$2f$cargo$2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(updateTruckTurnoAction, "608d8ff96e8b098cee62cf6b38d1544b5a5ec66e31", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$paddy$2f$cargo$2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(deleteTruckReceptionAction, "405e7bbec01d48e9d7d90f457ec0439586ff0b456f", null);
}),
...
"[project]/paddy/cargo/.next-internal/server/app/receptions/page/actions.js { ACTIONS_MODULE0 => \"[project]/paddy/cargo/src/actions/truckReceptionActions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE1 => \"[project]/paddy/cargo/src/actions/fetchProducersAction.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([]);
var __TURBOPACK__imported__module__$5b$project$5d2f$paddy$2f$cargo$2f$src$2f$actions$2f$truckReceptionActions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/paddy/cargo/src/actions/truckReceptionActions.ts [app-rsc] (ecmascript)");
...
"[project]/paddy/cargo/.next-internal/server/app/receptions/page/actions.js { ACTIONS_MODULE0 => \"[project]/paddy/cargo/src/actions/truckReceptionActions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE1 => \"[project]/paddy/cargo/src/actions/fetchProducersAction.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "0037935cdcff978a6805f61981c08fe8cdfab5eaf9",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$paddy$2f$cargo$2f$src$2f$actions$2f$truckReceptionActions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getNextTurnoAction"],
    "00ffed22151d008e6a1c3373c7ae3614463e364065",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$paddy$2f$cargo$2f$src$2f$actions$2f$truckReceptionActions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getTurnosTodayAction"],
    "401fd7e2cce3cc7b43e9956d041f18b7c603deb92a",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$paddy$2f$cargo$2f$src$2f$actions$2f$truckReceptionActions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["createTruckReceptionAction"],
    "4021f17fb898e1ad86fcca663f85fed167403e6876",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$paddy$2f$cargo$2f$src$2f$actions$2f$truckReceptionActions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getTruckReceptionsGridAction"],
    "4033c54ef6a1cf7531097325a91c4fd9100a53bead",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$paddy$2f$cargo$2f$src$2f$actions$2f$truckReceptionActions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getTruckReceptionByIdAction"],
    ...
    "405e7bbec01d48e9d7d90f457ec0439586ff0b456f",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$paddy$2f$cargo$2f$src$2f$actions$2f$truckReceptionActions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["deleteTruckReceptionAction"],
    "40607a23e110a792b478bd237b3a01d9cf5060c36c",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$paddy$2f$cargo$2f$src$2f$actions$2f$truckReceptionActions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["recordTareWeightAction"],
    "60052f665745ab54597007d2d90027fb8d4202a216",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$paddy$2f$cargo$2f$src$2f$actions$2f$truckReceptionActions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["updateTruckReceptionAction"],
    "608d8ff96e8b098cee62cf6b38d1544b5a5ec66e31",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$paddy$2f$cargo$2f$src$2f$actions$2f$truckReceptionActions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["updateTruckTurnoAction"],
    "60af9d152c7f1d88e888614da640f34a00bd2f0c61",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$paddy$2f$cargo$2f$src$2f$actions$2f$truckReceptionActions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["updateTruckStatusAction"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$paddy$2f$cargo$2f2e$next$2d$internal$2f$server$2f$app$2f$receptions$2f$page$2f$actions$2e$js__$7b$__ACTIONS_MODULE0__$3d3e$__$225b$project$5d2f$paddy$2f$cargo$2f$src$2f$actions$2f$truckReceptionActions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE1__$3d3e$__$225b$project$5d2f$paddy$2f$cargo$2f$src$2f$actions$2f$fetchProducersAction$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$server__actions__loader$2c$__ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i('[project]/paddy/cargo/.next-internal/server/app/receptions/page/actions.js { ACTIONS_MODULE0 => "[project]/paddy/cargo/src/actions/truckReceptionActions.ts [app-rsc] (ecmascript)", ACTIONS_MODULE1 => "[project]/paddy/cargo/src/actions/fetchProducersAction.ts [app-rsc] (ecmascript)" } [app-rsc] (server actions loader, ecmascript) <locals>');
var __TURBOPACK__imported__module__$5b$project$5d2f$paddy$2f$cargo$2f$src$2f$actions$2f$truckReceptionActions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/paddy/cargo/src/actions/truckReceptionActions.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$paddy$2f$cargo$2f$src$2f$actions$2f$fetchProducersAction$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/paddy/cargo/src/actions/fetchProducersAction.ts [app-rsc] (ecmascript)");
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__020f606a._.js.map