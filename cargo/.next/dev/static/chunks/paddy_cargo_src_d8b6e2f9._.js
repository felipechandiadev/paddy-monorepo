...
const SerialPortConfigDialog = ({ open, onClose, isConnected, isAvailable, isConnecting, dialogError, onChoosePort, onDisconnect })=>{
    ...
    const baudOptions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$paddy$2f$cargo$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "SerialPortConfigDialog.useMemo[baudOptions]": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$paddy$2f$cargo$2f$src$2f$services$2f$serialPort$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SERIAL_BAUD_RATES"].map({
                "SerialPortConfigDialog.useMemo[baudOptions]": (r)=>({
                        id: r,
                        label: String(r)
                    })
            }["SerialPortConfigDialog.useMemo[baudOptions]"])
    }["SerialPortConfigDialog.useMemo[baudOptions]"], []);
    const dataBitsOptions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$paddy$2f$cargo$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "SerialPortConfigDialog.useMemo[dataBitsOptions]": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$paddy$2f$cargo$2f$src$2f$services$2f$serialPort$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SERIAL_DATA_BITS"].map({
                "SerialPortConfigDialog.useMemo[dataBitsOptions]": (b)=>({
                        id: b,
                        label: `${b} bits`
                    })
            }["SerialPortConfigDialog.useMemo[dataBitsOptions]"])
    }["SerialPortConfigDialog.useMemo[dataBitsOptions]"], []);
    const parityOptions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$paddy$2f$cargo$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "SerialPortConfigDialog.useMemo[parityOptions]": ()=>PARITY_OPTIONS.map({
                "SerialPortConfigDialog.useMemo[parityOptions]": (o)=>({
                        id: o.id,
                        label: o.label
                    })
            }["SerialPortConfigDialog.useMemo[parityOptions]"])
    }["SerialPortConfigDialog.useMemo[parityOptions]"], []);
...
_s(SerialPortConfigDialog, "hL3nJAzWjfHBTtPAaNmU+TsBm8M=");
...
//# sourceMappingURL=paddy_cargo_src_d8b6e2f9._.js.map