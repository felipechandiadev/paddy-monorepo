...
import type { TruckReception, TruckReceptionGridRow } from '@/actions/truckReceptionActions';
import {
...
/** Respaldo para el ticket si falla la carga completa desde la API. */
  ...
  return (
    <>
      <DataGrid
        ...
        createForm={
          <ReceptionManualCreateForm onCreated={refresh} />
        }
      />
