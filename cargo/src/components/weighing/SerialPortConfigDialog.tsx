...
const BAUD_SELECT_OPTIONS = SERIAL_BAUD_RATES.map((r) => ({ id: r, label: String(r) }));
const DATA_BITS_SELECT_OPTIONS = SERIAL_DATA_BITS.map((b) => ({ id: b, label: `${b} bits` }));
const PARITY_SELECT_OPTIONS = [
  { id: 'none', label: 'Ninguna (N)' },
  { id: 'even', label: 'Par (E)' },
  { id: 'odd', label: 'Impar (O)' },
];
