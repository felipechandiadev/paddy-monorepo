...
export interface DispatchManualCreateFormProps {
  onClose?: () => void;
  onCreated?: () => void;
}

export const DispatchManualCreateForm: React.FC<DispatchManualCreateFormProps> = ({
  onClose,
  onCreated,
}) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (grossNum !== undefined) {
        await registerDispatchGrossWeightAction({
    ...
    <div className="p-1">
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <p className="text-xs text-muted-foreground -mt-2">
          Si indicas bruto, el despacho queda finalizado con el neto calculado (bruto − tara).
        </p>
